...
btnMainMenu = tk.Button(adminBody,text="Main Menu",command=exit,width=10)
...
btnAddUser = tk.Button(removeUserBody,text="Remove User",command=exit,width=10, height=2)
btnAddUser.place(x=750,y=50)
btnAddUser.config(font=("Times New Roman", 28))
